...
namespace eyazisma.online.api
{
    internal static class Constants
    {
        ...
        public const string RELATION_TYPE_CORE =
        ...
        public const string SIFRELEME_YONTEMI =
        ...
        public static Uri URI_PARAFOZETI =
            PackUriHelper.CreatePartUri(new Uri(URI_PARAFOZETI_STRING, UriKind.Relative));
        ...
        public static Uri URI_NIHAIUSTVERI =
            PackUriHelper.CreatePartUri(new Uri(URI_NIHAIUSTVERI_STRING, UriKind.Relative));

        public static Uri URI_BELGEHEDEF =
            PackUriHelper.CreatePartUri(new Uri(URI_BELGEHEDEF_STRING, UriKind.Relative));
        ...
        public static Uri URI_ARSIVOZELLIKLERI =
            PackUriHelper.CreatePartUri(new Uri(URI_ARSIVOZELLIKLERI_STRING, UriKind.Relative));

        public static Uri URI_SIFRELIICERIKBILGISI =
            PackUriHelper.CreatePartUri(new Uri(URI_SIFRELIICERIKBILGISI_STRING, UriKind.Relative));

        public static string[] KEPHS_DOMAINS =
        {
            "hs01.kep.tr",
            "hs02.kep.tr",
            "hs03.kep.tr",
        ...
        public static string[] TUZEL_SAHIS_ID_SCHEMES =
        {
            "MERSIS",
            "VBYS",
            "DERBIS",
        ...
        public static Uri URI_PAKETOZETI =>
            PackUriHelper.CreatePartUri(new Uri(URI_PAKETOZETI_STRING, UriKind.Relative));

        /// <summary> Ek bileşeni ilişkisi Id formatı.</summary>
        public static string ID_ROOT_EK(string id)
        {
            return string.Format("IdEk_{0}", id);
        }

        /// <summary> İmzasız Ek bileşeni ilişkisi Id formatı.</summary>
        public static string ID_ROOT_IMZASIZEK(string id)
        {
            return string.Format("IdImzasizEk_{0}", id);
        }
    }
}