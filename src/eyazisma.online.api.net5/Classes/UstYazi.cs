...
namespace eyazisma.online.api.Classes
{
    ...
    public sealed class UstYazi
    {
        ...
        public sealed class Kilavuz : IUstYaziFluent
        {
            ...
            private readonly Stream _dosyaStream;
            ...
            {
                return new(_dosyaStream, _dosyaAdi, _mimeTuru);
            }
            ...
            /// <remarks>Zorunlu alandır.</remarks>
            public static IUstYaziFluentDosya DosyaAta(Stream dosyaStream)
            {
                return new Kilavuz(dosyaStream);
            }
            ...
            /// <remarks>Zorunlu alandır.</remarks>
            public static IUstYaziFluentDosya DosyaAta(string dosyaYolu)
            {
                return new Kilavuz(File.OpenRead(dosyaYolu));
            }
        }
    }
}