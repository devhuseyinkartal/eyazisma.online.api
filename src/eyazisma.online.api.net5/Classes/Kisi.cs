...
namespace eyazisma.online.api.Classes
{
    ...
    public sealed class Kisi
    {
        ...
        {
            private readonly IsimTip _ilkAdi;
            private IsimTip _soyadi, _ikinciAdi, _unvan;
            ...
            public Kisi Olustur()
            {
                return new(_onEk, _ilkAdi, _ikinciAdi, _soyadi, _unvan);
            }
            ...
            /// <remarks>Zorunlu alandır.</remarks>
            public static IKisiFluentIlkAdi IlkAdiAta(IsimTip ilkAdi)
            {
                return new Kilavuz(ilkAdi);
            }
        }
    }
}