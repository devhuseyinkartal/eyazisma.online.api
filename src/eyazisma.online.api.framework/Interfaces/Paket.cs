...
namespace eyazisma.online.api.Interfaces
{
    ...
    public interface IPaketV1XOkuBilesen
    {
        ...
        bool PaketOzetiDogrula(PaketOzeti ozet, ref List<DogrulamaHatasi> sonuclar,
        ...
        /// <param name="dagitimTanimlayici">Doğrulama tek bir dağıtım için yapılacaksa burada belirtilir.</param>
        /// <returns>Doğrulamanın başarılı olup olmadığını belirtir.</returns>
        bool NihaiOzetDogrula(NihaiOzet ozet, ref List<DogrulamaHatasi> sonuclar,
            TanimlayiciTip dagitimTanimlayici = null);
        ...
        bool ReferansDogrula(Referans referans, ref List<DogrulamaHatasi> sonuclar,
            TanimlayiciTip dagitimTanimlayici = null);
    ...
    public interface IPaketV1XGuncelleEkDosya
    {
        ...
        ///     List -> Pakete ait tüm doğrulama hatalarını belirtir.
        /// </param>
        IPaketV1XGuncelleDogrula Dogrula(TanimlayiciTip dagitimTanimlayici,
    ...
    public interface IPaketV2XOkuBilesen
    {
        ...
        /// <param name="dagitimTanimlayici">Doğrulama tek bir dağıtım için yapılacaksa burada belirtilir.</param>
        /// <returns>Doğrulamanın başarılı olup olmadığını belirtir.</returns>
        bool ParafOzetiDogrula(ParafOzeti ozet, ref List<DogrulamaHatasi> sonuclar,
            TanimlayiciTip dagitimTanimlayici = null);
    ...
    public interface IPaketV2XGuncelleEkDosya
    {
        ...
        ///     List -> Pakete ait tüm doğrulama hatalarını belirtir.
        /// </param>
        IPaketV2XGuncelleDogrula Dogrula(TanimlayiciTip dagitimTanimlayici,
            Action<bool, List<DogrulamaHatasi>> dogrulamaAction);
    }
