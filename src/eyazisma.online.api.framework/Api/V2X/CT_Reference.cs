...
namespace eyazisma.online.api.Api.V2X
{
    ...
    {
        [XmlElement(Order = 0)] public CT_DigestItem DigestItem { get; set; }

        [XmlElement("DigestItem", Order = 1)] public CT_DigestItem DigestItem1 { get; set; }

        [XmlAttribute(DataType = "ID")] public string Id { get; set; }

        [XmlAttribute(DataType = "anyURI")] public string URI { get; set; }

        [XmlAttribute(DataType = "anyURI")] public string Type { get; set; }
    }
}