...
namespace eyazisma.online.api.framework.Classes
{
    ...
    public sealed class IletisimBilgisi
    {
        ...
        public sealed class Kilavuz : IIletisimBilgisiFluent
        {
            ...
            public static IIletisimBilgisiFluentV1X Versiyon1X() => new Kilavuz();
            public static IIletisimBilgisiFluentV2X Versiyon2X() => new Kilavuz();
            ...
            {
                return new IletisimBilgisi(_telefon, _telefonDiger, _faks, _ePosta, _kepAdresi, _webAdresi, _adres, _ilce, _il, _ulke);
            }
