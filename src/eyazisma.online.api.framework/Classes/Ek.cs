...
namespace eyazisma.online.api.Classes
{
    ...
    public sealed class Ek
    {
            ...
            IEkDEDFluentImzaliMi
        {
            ...
            public Ek Olustur()
            {
                return new Ek(_id, _belgeNo, EkTuru.DED, _dosyaAdi, _mimeTuru, _ad, _siraNo, _aciklama, null, _ozId,
                    _imzaliMi, null);
            }
            ...
            IEkHRFFluentOzet
        {
            ...
            public Ek Olustur()
            {
                return new Ek(_id, _belgeNo, EkTuru.HRF, null, null, _ad, _siraNo, _aciklama, _referans, _ozId, false,
                    _ozet);
            }
