...
namespace eyazisma.online.api.framework.Classes
{
    ...
    public sealed class Ustveri
    {
        ...
        /// <summary>
        /// Belgeyle ilgili olarak iletişim kurulacak kurum, kuruluş, gerçek veya tüzel kişi bilgilerinin listelendiği elemandır.
        /// </summary>
        ...
        {
            public static IUstveriV1XFluent Versiyon1X() => new UstveriV1XFluent();
            public static IUstveriV2XFluent Versiyon2X() => new UstveriV2XFluent();
        }
