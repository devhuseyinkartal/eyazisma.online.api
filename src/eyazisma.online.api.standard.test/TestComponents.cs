...
namespace eyazisma.online.api.standard.test
{
    public static class TestComponents
    {
        ...
        {
            using (MemoryStream paketStreamIn = new MemoryStream(PAKET_V1X_BYTE_ARRAY()))
            {
        ...
        {
            using (MemoryStream paketStreamIn = new MemoryStream(PAKET_V2X_BYTE_ARRAY()))
            {
                using (var paketStream = new MemoryStream())
                {
                    paketStreamIn.CopyTo(paketStream);
        ...
        public static string SIFRELI_PAKET_V1X_SIFRELI_ICERIK_BOS_FILE_PATH => Path.Combine(TEST_BASE_DIRECTORY, "sifrelipaketv1xicerikbos.eyps");

        public static string SIFRELI_PAKET_V2X_SIFRELI_ICERIK_BOS_FILE_PATH => Path.Combine(TEST_BASE_DIRECTORY, "sifrelipaketv2xicerikbos.eyps");
